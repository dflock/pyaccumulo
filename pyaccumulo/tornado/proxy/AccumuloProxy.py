...
class Iface(object):
  ...
  def offlineTable(self, login, tableName, callback):
    """
    Parameters:
     - login
     - tableName
  ...
  def onlineTable(self, login, tableName, callback):
    """
    Parameters:
     - login
     - tableName
...
class Processor(Iface, TProcessor):
  ...
  def process_offlineTable(self, seqid, iprot, oprot, callback):
    ...
    with stack_context.ExceptionStackContext(handle_exception):
      yield gen.Task(self._handler.offlineTable, args.login, args.tableName)
  ...
  def process_onlineTable(self, seqid, iprot, oprot, callback):
    ...
    with stack_context.ExceptionStackContext(handle_exception):
      yield gen.Task(self._handler.onlineTable, args.login, args.tableName)
